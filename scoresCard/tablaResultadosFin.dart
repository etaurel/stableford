...
class ResultadosFin extends StatefulWidget {
  @override
  ...
  ResultadosFin({List<DataJugadorScore> dataSCJugadores, String logo, String image, int indiceJuga}) {
    print(indiceJuga);
  ...
  _ResultadosFinState createState() => _ResultadosFinState(
      dataSCJugadores: dataJugadoresScore, logo: logo, image: image, indiceJuga: indiceJuga);
}

class _ResultadosFinState extends State<ResultadosFin> {
...
//                color: Color(0xFF1f2f50) ,
  ...
  _mostraFirmaMarker(Uint8List firma) {
    //print('************************************' + firma.length.toString());
    if (firma == null || firma.length < 10) {
      return Container(
        color: Colors.black12,
