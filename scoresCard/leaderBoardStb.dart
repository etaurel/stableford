...
class LeaderboardStb extends StatefulWidget {
  final int idTorneo;
  LeaderboardStb({@required this.idTorneo}) : super();
...
class LeaderboardState extends State<LeaderboardStb> {
                  ...
                  cells: [
                      ...
                      Row(
                        children: <Widget>[
                          CircleAvatar(
                            ...
                            //AssetImage('assets/jugadores/1.jpg'),
                    ...
                    DataCell(
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              (jugador.hoyos_terminados == 0 || jugador.state_play == '0') ? '' : UserFunctions.scoreLBSta(
                    ...
                    DataCell(
                      Row(
                        ...
                        children: <Widget>[
                          Text(
                            (jugador.hoyos_terminados == 0 || jugador.state_play == '0') ? '' : UserFunctions.scoreLBHoyo(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: PreferredSize(
          preferredSize: Size.fromHeight(259),
...
//                assetImage: 'assets/ScoreCard2.png'),
              ...
              Container(
                ...
                alignment: Alignment.center,
                child: Text(
                  '↓ Ordenar por: Tees | Jugadores | Hcp | Score ↓',
                  style: TextStyle(
                    fontSize: 15,
                    color: Colors.white,
                  ),
...
//    print('-------------------------------------------------_postTorneoLD.postClub.logo');
//    print(_postTorneoLD.postClub.logo);
    setState(() {});
  }
