              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child:
                    Text(
                      UserFunctions.scoreZeroToEmpty(jugador.hoyos[hoyoNro - 1].golpesHcp),
                      // "(${(jugador.hoyos[hoyoNro - 1].golpesHcp.toString())})",
                      textScaleFactor: 1,
                      //style: TextStyle(fontSize: 45, color: Colors.white),
                      style: TextStyle(
                          fontSize: 22,
...
//                                           ),
                                    ...
                                    Text(
                                      // UserFunctions.scoreZeroToEmpty(jugadorItem.hoyos[_nroHoyo - 1].golpesHcp),
                                      " ${(jugadorItem.hoyos[_nroHoyo - 1].golpesHcp.toString())}",
                                      textScaleFactor: 1,
                                      //style: TextStyle(fontSize: 45, color: Colors.white),
                                      style: TextStyle(
                                          fontSize: 20,
